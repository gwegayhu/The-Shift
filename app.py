...
with col2:
    ...
    if submit_btn:
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    if fraud_res == "flagged_fraud":
                        ...
                        st.info(f"🟢 **ML Classifier Alert:** Transaction status evaluates to **{fraud_res.upper()}**")
        ...
        st.info("Fill out the transaction metrics configuration details on the left dashboard and click 'Execute End-to-End Pipeline' to visualize data flow transformations across your infrastructure.")
